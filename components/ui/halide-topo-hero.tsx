...
export const HalideTopoHero: React.FC<HalideTopoHeroProps> = ({ className }) => {
  ...
  return (
    <div className={cn("relative w-full h-screen overflow-hidden bg-[#0a0a0a] flex items-center justify-center font-sans", className)}>
      <style>{`
      ...
      <div className="halide-container">
        ...
        <div className="interface-grid">
          <div className="font-bold flex items-center gap-2">
            <img src="/logo.png" alt="Halide Core Logo" className="w-8 h-8 rounded-lg shadow-lg border border-white/10" />
            <span className="tracking-tighter uppercase text-sm">HALIDE_CORE</span>
          </div>
